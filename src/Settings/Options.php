...
final class Options {
        ...
        private function get_option_schema(): array {
                return [
						...
						'nudge_enabled'            => true,
						'nudge_message'            => \__( 'Need a hand? Tap to chat or send us a quick email.', 'chatkit-wp' ),
						'nudge_initial_delay'      => 12,
						'nudge_repeat_delay'       => 36,
                                ],
                        ],
                ];
        }
        ...
        private const LEGACY_OPTION_MAP = [
				...
				'chatkit_advanced_settings'   => [
						...
						'nudge_enabled'            => 'chatkit_nudge_enabled',
						'nudge_message'            => 'chatkit_nudge_message',
						'nudge_initial_delay'      => 'chatkit_nudge_initial_delay',
						'nudge_repeat_delay'       => 'chatkit_nudge_repeat_delay',
                ],
        ];
